...
ALTER TABLE ONLY "public"."dynamic_credential_entry"
    ADD CONSTRAINT "FK_d57808fe08b77464f6a88a25494" FOREIGN KEY ("resolver_id") REFERENCES "dynamic_credential_resolver"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."dynamic_credential_entry"
    ADD CONSTRAINT "FK_e97db563e505ae5f57ca33ef221" FOREIGN KEY ("credential_id") REFERENCES "credentials_entity"("id") ON DELETE CASCADE;
